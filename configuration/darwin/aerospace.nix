  ...
  services.aerospace = {
    ...
    settings = {
      ...
      mode.main.binding = {
        ...
        alt-shift-up = "move-node-to-workspace next --wrap-around --focus-follows-window";
        alt-shift-down = "move-node-to-workspace prev --wrap-around --focus-follows-window";
        alt-up = "workspace next --wrap-around";
        alt-down = "workspace prev --wrap-around";
        alt-e = "fullscreen";
