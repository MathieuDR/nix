# https://git.allpurposem.at/mat/Computer/src/branch/main/common/hm/modules/signal.nix
{...}: {
  flake.modules.homeManager.signal = {pkgs, ...}: let
    catppuccin-css = pkgs.fetchurl {
    ...
    home.packages = [
      (pkgs.signal-desktop-bin.overrideAttrs (finalAttrs: previousAttrs: {
        ...
        postInstall = ''
          ...
          cp ${catppuccin-css} temp/stylesheets/catppuccin-mocha.css
